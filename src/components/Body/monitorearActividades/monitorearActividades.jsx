    ...
    <div>
      ...
      <main className="container">
        <section className="monitoreo mt-4">
          <h2>
            <i className="fas fa-history" /> Bitácora de Acceso{" "}
          </h2>
          ...
          <div className="table-responsive">
            ...
            >
              <thead className="thead-dark">
                <tr>
                  <th id="th1" style={{ backgroundColor: "#1f5cb8" }}>
                    {" "}
                    <i className="fas fa-user" /> ID Usuario
                  </th>
                  <th id="th2" style={{ backgroundColor: "#1f5cb8" }}>
                    <i className="fas fa-clock" /> Fecha y Hora de Acceso
                  </th>
                </tr>
              </thead>
              <tbody>
