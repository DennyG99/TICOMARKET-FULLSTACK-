    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const nuevasCantidadVentas = datos.map(cantidadVenta => cantidadVenta.cantidadVentas);
                const nuevosNombreTienda = datos.map(nombreTienda => nombreTienda.nombreTienda);
